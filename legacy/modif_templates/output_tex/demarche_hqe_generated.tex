...
\begin{tcolorbox}[
    ...
    coltitle=white,
    title={\faLeaf\hspace{0.5em}Haute qualité environnementale},
...
\begin{tcolorbox}[
    ...
    fonttitle=\bfseries,
    coltitle=white,
    title={\faTree\hspace{0.3em}ECO-Construction (famille F1)},
...
\begin{tcolorbox}[
    ...
    fonttitle=\bfseries,
    coltitle=white,
    title={\faCog\hspace{0.3em}ECO-Gestion (famille F2)},
...
\begin{tcolorbox}[
    ...
    fonttitle=\bfseries,
    coltitle=white,
    title={\faHome\hspace{0.3em}Confort (famille F3)},
    colbacktitle=ecoBleu,
    rounded corners,
    boxrule=1.5pt,
    left=8pt, right=8pt, top=8pt, bottom=8pt
...
\begin{tcolorbox}[
    ...
    fonttitle=\bfseries,
    coltitle=white,
    title={\faHeart\hspace{0.3em}Santé (famille F4)},
...
\textbf{\textcolor{red!60!black}Cible n°14 « qualité de l'air »}
